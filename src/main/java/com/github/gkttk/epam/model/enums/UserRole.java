...
public enum UserRole {
    ADMIN("SORT_COMMENTS","UPDATE_COMMENT", "DELETE_COMMENT", "CHANGE_POINTS", "SORT_USERS", "USERS", "CHANGE_STATUS","LOGOUT", "FORM_ORDER", "MENU",
            "MY_ORDERS", "COMMENTS", "SAVE_ORDER", "CANCEL_DISH", "RATE_COMMENT",
            "SORT_DISHES", "TO_BASKET", "DISH_COMMENTS", "ADD_COMMENT", "TAKE_ORDER",
            "CANCEL_ORDER"),
    USER("SORT_COMMENTS", "UPDATE_COMMENT", "DELETE_COMMENT", "LOGOUT", "FORM_ORDER", "MENU", "MY_ORDERS", "COMMENTS",
