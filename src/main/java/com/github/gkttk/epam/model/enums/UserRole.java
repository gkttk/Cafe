...
//todo delete commands from admin,
public enum UserRole {
    ADMIN("ADD_DISH","CHANGE_AVATAR","ADD_MONEY","ORDER_HISTORY","SORT_COMMENTS","UPDATE_COMMENT", "DELETE_COMMENT", "CHANGE_POINTS", "SORT_USERS", "USERS", "CHANGE_STATUS","LOGOUT", "FORM_ORDER", "MENU",
            "MY_ORDERS", "COMMENTS", "SAVE_ORDER", "CANCEL_DISH", "RATE_COMMENT",
            "SORT_DISHES", "TO_BASKET", "DISH_COMMENTS", "ADD_COMMENT", "TAKE_ORDER", "CANCEL_ORDER"),
    USER("CHANGE_AVATAR","ADD_MONEY","ORDER_HISTORY","SORT_COMMENTS", "UPDATE_COMMENT", "DELETE_COMMENT", "LOGOUT", "FORM_ORDER", "MENU", "MY_ORDERS", "COMMENTS",
