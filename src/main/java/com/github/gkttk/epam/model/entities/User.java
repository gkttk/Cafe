...
public class User extends Entity {
    ...
    public User(Long id, String login, UserRole role, int points, BigDecimal money, boolean blocked, String imgBase64) {
        super(id);
        this.login = login;
        this.role = role;
        this.points = points;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(login, role, points, money, blocked, imgBase64);
    }

    @Override
    public String toString() {
        return String.format("User id: %d, login: %s, role: %s, points: %d, money: %f, is blocked: %b",
                getId(), login, role.name(), points, money, blocked);
    }
}
