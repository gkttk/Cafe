...
/**
 * Current class represents data from dish table.
 */
public class Dish extends Entity {
    ...
    public Dish(String name, DishType type, BigDecimal cost, String imgBase64) {
        super(null);
        this.name = name;
        this.type = type;
        this.cost = cost;
    ...
    public Dish(Long id, String name, DishType type, BigDecimal cost, String imgBase64) {
        super(id);
        this.name = name;
        this.type = type;
        this.cost = cost;
